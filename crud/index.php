      ...
      <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
          <?php 
           ...
           ?>
          <h2 style="margin: 30px 0 30px 0;">Data Diri</h2>
          <div> <a href="<?php echo 'insert.php'; ?>" class="m-2 btn btn-outline-success"> Insert Data</a></div>
              ...
              <tbody>
                ...
                <?php while($data = mysqli_fetch_array($result)): ?>
                  <tr>
                    ...
                    <td>
                      <a href="<?php echo "update.php?nama_lengkap=".$data['nama_lengkap']; ?>" class="btn btn-outline-warning btn-sm"> Update</a>
                      &nbsp;&nbsp;
                      <a href="<?php echo "delete.php?nama_lengkap=".$data['nama_lengkap']; ?>" class="btn btn-outline-danger btn-sm"> Delete</a>
                    </td>
                  </tr>
                <?php endwhile ?>
              </tbody>
